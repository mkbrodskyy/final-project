...
function SavedArticlesHeader({ savedArticlesHeader }) {
  ...
  return (
    <div className="saved-articles-header-block">
      <h2 className="saved-articles-title">Saved articles</h2>
      <div className="saved-articles-user-info">
      ...
      {savedArticlesHeader.count > 0 && (
        <div className="saved-articles-keywords">
          By keywords:{" "}
          <span className="saved-articles-keywords-list">
